    ...
    def dog_keypoints( self,img_dogs , img_max , threshold ):
            ...
            for octave_idx in range(self.N_OCTAVES):
                ...
                for dog_idx in range(1, len(img_octave_dogs)-1):
                    ...
                    #candidates = set(self.refine(dog,threshold))& set(self.corners(dog)) & set(self.contrast( dog , img_max, threshold ))
...
##############################################STEP4################################################
    ...
    def combine_img_with_pattern(self):
                imgs_dirs = ['sift_0{}'.format(i) for i in range(1,3) ] #range(1,5)
                image_patterns = {}
                image_patterns_gray = {}
                images = {}
                images_gray = {}
    ...
    def combine_img_with_pattern2(self,fileName):
                imgs_dirs = 'sift_01'
                image_patterns = {}
                image_patterns_gray = {}
                images = {}
